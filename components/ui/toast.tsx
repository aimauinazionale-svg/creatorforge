...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-start justify-between gap-4 overflow-hidden rounded-md border p-4 pr-6 shadow-lg transition-all " +
    ...
    "sm:data-[state=open]:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-destructive/50 bg-destructive text-destructive-foreground [&>button]:text-destructive-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  <ToastPrimitives.Action
    ...
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium transition-colors " +
        "hover:bg-muted focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
      className
    )}
    {...props}
  />
