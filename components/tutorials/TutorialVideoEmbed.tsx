  ...
  return (
    <div
      className={cn(
        ...
        "border border-dashed border-rose-500/30 bg-gradient-to-br from-orange-500/10 via-background to-pink-500/10",
        className
      )}
      aria-label={t("comingSoon")}
    >
      <div className="flex h-14 w-14 items-center justify-center rounded-full bg-rose-500/20 ring-1 ring-rose-500/30">
        <Play className="h-6 w-6 text-rose-400" aria-hidden="true" />
      </div>
